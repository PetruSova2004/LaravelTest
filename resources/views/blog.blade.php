            ...
            <ul class="nav navbar-nav menu_nav ml-auto mr-auto">
              ...
              <li class="nav-item submenu dropdown">
                ...
                <ul class="dropdown-menu">
                  <li class="nav-item"><a class="nav-link" href="products.blade.php">Shop Category</a></li>
              ...
              <li class="nav-item active submenu dropdown">
                ...
                <ul class="dropdown-menu">
                  <li class="nav-item active"><a class="nav-link" href="blog.blade.php">Blog Single</a></li>
                          ...
                          <div class="col-md-9">
                              <div class="blog_post">
                                  ...
                                  <div class="blog_details">
                                      ...
                                      <a class="button button-blog" href="single-blog.blade.php">View More</a>
                                  </div>
                              </div>
                          </div>
                      </article>
                              ...
                              <div class="blog_post">
                                  ...
                                  <div class="blog_details">
                                      ...
                                      <p>MCSE boot camps have its supporters and its detractors. Some people do not understand
                                          why you should have to spend money on boot camp when you can get the MCSE study
                                          materials yourself at a fraction.</p>
                                      <a href="single-blog.blade.php" class="button button-blog">View More</a>
                                  </div>
                              </div>
                          </div>
                      </article>
