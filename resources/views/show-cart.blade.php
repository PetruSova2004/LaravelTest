                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="card text-center card-product">
                                    <div class="card-product__img">
                                        <img class="card-img" src="/public/storage/{{$cart->product->img}}" alt="">
                                        <ul class="card-product__imgOverlay">
                                            <li>
                                                <a href={{route('show.single.product', ['slug' => $cart->product->slug])}}>
                                            ...
                                            <li>
                                                <a href={{route('delete.cart', ['id' => $cart->id])}}>
                                                    <button><i class="ti">Delete</i></button>
                                                </a>
                                            </li>
                                    ...
                                    <div class="card-body">
                                        <p>{{$cart->product->category->title}}</p>
                                        <h4 class="card-product__title"><a href="#">{{$cart->product->title}}</a></h4>
                                        @if($subscriber)
                                            <p class="card-product__price">
                                                ${{round($cart->product->price - ($cart->product->price *($percent / 100)))}}
                                                .00</p>
                                        @endif
                                        @if(!$subscriber)
                                            <p class="card-product__price">${{$cart->product->price}}</p>
                                        @endif
                                    </div>
                                </div>
                            </div>
