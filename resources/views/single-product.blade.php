            ...
            <div class="col-lg-6">
                <div class="owl-carousel owl-theme s_Product_carousel">
                    <div class="single-prd-item">
                        <img class="img-fluid" src={{\Illuminate\Support\Facades\URL::asset($product->img)}} alt="">
                    </div>
                    <!-- <div class="single-prd-item">
                    ...
                    <div class="col-lg-6">
                        <div class="comment_list">
                            <div class="review_item">
                                <div class="media">
                                    <div class="d-flex">
                                        <img src="/public/assets/img/product/review-1.png" alt="">
                                    </div>
                            ...
                            <div class="review_item reply">
                                <div class="media">
                                    <div class="d-flex">
                                        <img src="/public/assets/img/product/review-2.png" alt="">
                                    </div>
                                    <div class="media-body">
                                        <h4>Blake Ruiz</h4>
                                        <h5>12th Feb, 2018 at 05:56 pm</h5>
                            ...
                            <div class="review_item">
                                <div class="media">
                                    <div class="d-flex">
                                        <img src="/public/assets/img/product/review-3.png" alt="">
                                    </div>
                                    <div class="media-body">
                                        <h4>Blake Ruiz</h4>
                                        <h5>12th Feb, 2018 at 05:56 pm</h5>
