                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="card text-center card-product">
                                    <div class="card-product__img">
                                        <img class="card-img" src="/public/storage/{{$product->img}}" alt="">
                                        <ul class="card-product__imgOverlay">
                                            ...
                                            <li>
                                                @auth()
                                                    <button type="submit">
                                                        <a href={{route('product.add.cart', ['id' => $product->id, 'user' => $authUser->id])}}>
                                                            <i class="ti-shopping-cart"
                                                            ></i>
                                                        </a>
                                                    </button>
                                                    <button>
                                                        <a href={{route('favorites.add', ['id' => $product->id, 'user' => $authUser->id])}}>
                                                            <i class="ti-heart"></i>
                                                        </a>
                                                    </button>
                                                @endauth
                                    ...
                                    <div class="card-body">
                                        ...
                                        @if($subscriber)
                                            <p class="card-product__price">
                                                ${{round($product->price - ($product->price *($percent / 100)))}}
                                                .00</p>
                                            <!-- Получаем цену со скидкой и округляем её -->
                                        @endif
                                        @if(!$subscriber)
